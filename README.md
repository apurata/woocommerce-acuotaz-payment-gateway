...
2. Download the plugin [click here](https://github.com/apurata/woocommerce-acuotaz-payment-gateway/releases/download/v0.4.4/woocommerce-apurata-payment-gateway.zip)
